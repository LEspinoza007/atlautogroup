        ...
        <div>
          ...
          <div className="flex items-center gap-3">
            ...
            <a href={MESSENGER_URL} target="_blank" rel="noopener noreferrer"
              className="p-2 bg-zinc-800 hover:bg-blue-500 rounded-lg transition-colors text-zinc-400 hover:text-white" aria-label="Messenger">
              <MessengerIcon />
            </a>
            ...
            <a href={INSTAGRAM_URL} target="_blank" rel="noopener noreferrer"
              className="p-2 bg-zinc-800 hover:bg-pink-600 rounded-lg transition-colors text-zinc-400 hover:text-white">
              <InstagramIcon />
            </a>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="space-y-3 text-sm">
            <div className="flex items-center gap-3">
              ...
              <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer"
                className="text-green-400 hover:text-green-300 transition-colors" aria-label="WhatsApp">
                <WhatsAppIcon />
              </a>
            </div>
